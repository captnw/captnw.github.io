...
function GalleryComponent(props) {
  ...
  return (
    <>
      <div className="horizontalCenter containerImage noPaddingBottom">
        <Image
      ...
      {images_len >= 2 && (
        <>
          <div className="horizontalCenter" id="horizontalList">
            <ul>{dotComponentList}</ul>
          </div>
        </>
      )}
    </>
